...
class Profesor_model extends CI_Model{
  	var $table_peticiones = 'peticion';
  	var $table_accesos = 'acceso';
  	var $table_partidas = 'partida';
  	var $table_usuarios = 'usuario';
	  
  	var $column_order_peticiones = array(null, 'sNombre', 'sApellidos', null , 'sEmail', null);
  	var $column_search_peticiones = array('sNombre','sApellidos', 'sEmail');

  	var $column_order_accesos = array(null, 'sNombre', 'sApellidos', null , 'sEmail', null);
  	var $column_search_accesos = array('sNombre','sApellidos', 'sEmail');

  	var $column_order_partidas = array(null, 'sNombre', 'sApellidos', null , 'sEmail', null);
  	var $column_search_partidas = array('sNombre','sApellidos', 'sEmail');

  	var $column_order_usuarios = array(null, 'sNombre', 'sApellidos', null , 'sEmail', null);
  	var $column_search_usuarios = array('sNombre','sApellidos', 'sEmail');
    ...
    */
    private function _get_datatables_query_peticiones() {
      	if ($this->session->userdata('admin') == 1) {
        	$this->db->from($this->table_peticiones);
      	} else {
      		$this->db->from($this->table_peticiones);
        	$this->db->where('iId_Usuario', $this->session->userdata('id_usuario'));
      	}
      
      	$i = 0;

      	foreach ($this->column_search_peticiones as $item) {
      ...
      if(isset($_POST['order'])) {
        $this->db->order_by($this->column_order_peticiones[$_POST['order']['0']['column']], $_POST['order']['0']['dir']);
      } 
