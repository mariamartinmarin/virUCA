...
class Mispeticiones_model extends CI_Model{
  var $table = 'peticion';
  var $column_order = array('sPeticion_lista', 'dFecha_Peticion','bPendiente',  null);
  var $column_search = array('sPeticion_lista', 'dFecha_Peticion');
  var $order = array('iId' => 'desc');
    ...
    */
    private function _get_datatables_query() {
      ...
      $this->db->where('peticion.iId_Usuario', $id_usuario);
    ...
    */
    ...
    /* 
      ...
      SALIDA:  Registro [asignatura].
    */
    public function respuesta_leida($iId) {
      $data = array('bLeido' => 1);
      $where = array('iId' => $iId);
