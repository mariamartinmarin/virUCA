    ...
    <div class="body">
        ...
        <div role="main" class="main">       
            <div class="container">
                ...
                <?php
                    echo "<blockquote><b>Turno:</b> Grupo ".$iTurno."</blockquote>";
                    $contCasilla = 1;
                    foreach ($casillas as $casilla) {
                        // Pinto la casilla.
                        echo "<div id='casilla".$contCasilla."' class='circulo fade' style='background:".$casilla->sColor."; border: 1px dotted black;'>";
                    ...
                    foreach ($resumen as $equipo) {
                        if ($equipo->iCasilla != 0) {
                            ...
                            $ficha = '<div class=ficha><img src='.base_url().'assets/img/'.$equipo->iGrupo.'.png></div>';
                            echo "<script>";
