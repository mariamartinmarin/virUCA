        ...
        <div class="body">
            ...
            <div role="main" class="main">
                ...
                <div class="container">
                    ...
                    <?php if ($pregunta != "") { ?>
                    <?=form_open(base_url().'index.php/preguntas/eliminar_todos');?>
                    <?php foreach($pregunta as $fila){ ?>
                        ...
                        <div class="col-md-3"><span class="show-grid-block">
                            <a href="<?=base_url("index.php/preguntas/mod/$fila->iId")?>" 
                                class="btn btn-warning icon icon-pencil">
                            </a>
                            <a href="<?=base_url("index.php/preguntas/eliminar/$fila->iId")?>" 
                   ...
                   <?=form_open(base_url().'index.php/preguntas/nueva');
                   $activa = 0;
  ...
  <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true">&nbsp;</span>','</div>');?>
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <label for="bActiva[]"><b>¿Activar?</b></label>
