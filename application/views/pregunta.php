...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="active"><strong>Mis preguntas</strong></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                table = $('#table').DataTable({ 
                    ...
                    "ajax": {
                        "url": "<?php echo site_url('index.php/Pregunta/ajax_list')?>",
                        "type": "POST"
                    },
            ...
            function editar_pregunta(iId, iEdicion)
            {
                save_method = 'update';
                $('#form')[0].reset(); // reset form on modals
                $('.form-group').removeClass('has-error'); // clear error class
                ...
                $.ajax({
                    url : "<?php echo site_url('index.php/Pregunta/ajax_edit/')?>" + iId,
                    type: "GET",
                    dataType: "JSON",
                ...
                $.ajax({
                    url : "<?php echo site_url('index.php/Pregunta/ajax_editA/')?>" + iId,
                    type: "GET",
                    dataType: "JSON",
                    success: function(data)
                    {
                ...
                $.ajax({
                    url : "<?php echo site_url('index.php/Pregunta/ajax_editB/')?>" + iId,
                    type: "GET",
                    dataType: "JSON",
                    success: function(data)
                    {
                ...
                $.ajax({
                    url : "<?php echo site_url('index.php/Pregunta/ajax_editC/')?>" + iId,
                    type: "GET",
                    dataType: "JSON",
                    success: function(data)
                    {
                 ...
                 $.ajax({
                    url : "<?php echo site_url('index.php/Pregunta/ajax_editD/')?>" + iId,
                    type: "GET",
                    dataType: "JSON",
                    success: function(data)
                    {
                ...
                $.ajax({
                    url : "<?php echo site_url('index.php/Pregunta/obtener_verdadera/')?>" + iId,
                    type: "GET",
                    dataType: "JSON",
                    success: function(data)
                    {
                        ...
                        if (iEdicion == 0) {
                            $('#modal_form_noedit').modal('show'); // show bootstrap modal when complete loaded    
                            $('.modal-title').text('Visualizar pregunta'); // Set title to Bootstrap modal title
                        } else {
            ...
            function save()
            {
                ...
                if(save_method == 'add') {
                    url = "<?php echo site_url('index.php/Pregunta/ajax_add')?>";
                } else {
                    url = "<?php echo site_url('index.php/Pregunta/ajax_update')?>";
                }
        ...
        <!-- Bootstrap modal -->
        <div class="modal fade" id="modal_form_noedit" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h3 class="modal-title">Visualizar pregunta</h3>
                    </div>
                    <div class="modal-body form">
                        <form action="#" id="form" class="form-horizontal">
                            <input type="hidden" value="" name="iId"/> 
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <sub><b>Nota</b> No puedes editar la pregunta porque los profesores han comenzado la evaluación.</sub>
                                    </div>
                                </div>
